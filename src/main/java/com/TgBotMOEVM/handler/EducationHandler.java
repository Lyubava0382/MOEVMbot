...
public class EducationHandler implements Handler{
    private static final String GREETING = "Об обучении";
    ...
    public List<BotApiMethod<?>> handle(Update update) {
        ...
        return List.of(createMessage(update.getMessage().getChatId().toString(),
                GREETING, replyKeyboardMaker.getEducationKeyboard()));

    }

    @Override
    public BotCommand getCommandObject() {
        return ButtonCommand.EDUCATIONAL;
    }
}
