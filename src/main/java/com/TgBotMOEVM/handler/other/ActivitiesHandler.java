package com.TgBotMOEVM.handler.other;
...
public class ActivitiesHandler implements Handler {
    ...
    public List<BotApiMethod<?>> handle(Update update) {
        ...
        if (handbookRepository.findByCategory(ButtonCommand.ACTIVITIES.getDescription()).isPresent()){
            responses.add(createMessage(chatId.toString(),
                    handbookRepository.findByCategory(ButtonCommand.ACTIVITIES.getDescription()).get().getMessage()));
        }
        else{
            responses.add(createMessage(chatId.toString(),
    ...
    public BotCommand getCommandObject() {
        return ButtonCommand.ACTIVITIES;
    }
}
